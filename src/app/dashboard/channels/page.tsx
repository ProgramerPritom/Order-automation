...
export default function ChannelsPage() {
  ...
  // WhatsApp In-Dashboard QR Modal State
  const [qrModalOpen, setQrModalOpen] = useState(false);
  const [botStatus, setBotStatus] = useState<'idle' | 'starting' | 'qr_ready' | 'connected' | 'error'>('idle');
    ...
    <div className="space-y-6 w-full">
      ...
      {loading ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          {/* Live WhatsApp Card when connected via QR Web */}
          {botStatus === 'connected' &&
            channels.filter((c) => c.platform === 'whatsapp').length === 0 && (
              <div className="bg-white rounded-3xl p-6 sm:p-7 border border-emerald-200/80 hover:shadow-md transition-all shadow-sm flex flex-col justify-between relative overflow-hidden group">
                <div className="absolute top-0 right-0 w-28 h-28 rounded-full blur-2xl -mr-10 -mt-10 bg-emerald-50/50" />
                ...
                <div>
                  ...
                  <h3 className="font-extrabold text-base text-slate-900">
                    {connectedUser ? `${connectedUser} (WhatsApp)` : 'WhatsApp Business AI'}
                  </h3>
                  <p className="text-xs text-slate-500 mt-0.5 font-mono flex items-center gap-1">
                    <Phone className="w-3.5 h-3.5 text-emerald-600 inline" />
                    <span>+{connectedPhone || '8801767026831'}</span>
                  </p>
                  ...
                  <div className="mt-4 p-3 bg-emerald-50/70 border border-emerald-200/80 rounded-2xl space-y-2">
                    ...
                    <div className="flex items-center gap-1.5 bg-white p-1.5 rounded-xl border border-emerald-200">
                      <span className="font-mono text-[10px] text-slate-600 truncate flex-1 pl-1">
                        wa.me/{connectedPhone || '8801767026831'}
                      </span>
                      <button
                        type="button"
                        onClick={() => handleCopyWaLink(connectedPhone || '8801767026831')}
                        className="px-2 py-1 bg-emerald-600 hover:bg-emerald-700 text-white text-[10px] font-bold rounded-lg transition-all flex items-center gap-1 shrink-0"
                      >
                        {copiedLink === (connectedPhone || '8801767026831') ? (
                          <>
                            <Check className="w-3 h-3" />
                            <span>কপি হয়েছে!</span>
                          </>
                      ...
                      <a
                        href={`https://wa.me/${connectedPhone || '8801767026831'}?text=Hello,%20I%20want%20to%20order`}
                        target="_blank"
                        rel="noopener noreferrer"
                        className="p-1 text-slate-400 hover:text-emerald-700 hover:bg-emerald-50 rounded-lg transition-all shrink-0"
                        title="WhatsApp-এ ওপেন করুন"
                  ...
                  <div className="mt-4 space-y-2 text-xs border-t border-slate-100 pt-3">
                    <div className="flex justify-between py-0.5 text-slate-600">
                      <span>প্ল্যাটফর্ম:</span>
                      <span className="font-bold text-slate-800">WhatsApp Commerce Hub (Web QR)</span>
                    </div>
                    <div className="flex justify-between py-0.5 text-slate-600">
                      <span>অটো-রিপ্লাই ও সেলস এআই:</span>
                    ...
                    <div className="flex justify-between py-0.5 text-slate-600">
                      ...
                      <span className="font-bold text-slate-700">QR Code Linked Device</span>
                    </div>
                  </div>
                </div>
                ...
                <div className="mt-5 pt-4 border-t border-slate-100 space-y-3">
                  ...
                  >
                    ...
                    <span>{sendingGreeting ? 'পাঠানো হচ্ছে...' : '📨 টেস্ট মেসেজ পাঠান'}</span>
                  </button>
                  ...
                  >
                    <LogOut className="w-3.5 h-3.5 text-rose-500" />
                    <span>{disconnecting ? 'লগআউট হচ্ছে...' : 'লগআউট / ডিসকানেক্ট করুন'}</span>
                  </button>
                </div>
              </div>
            )}
      ...
      {qrModalOpen && (
        <div className="fixed inset-0 bg-slate-950/70 backdrop-blur-sm z-50 flex items-center justify-center p-4 animate-in fade-in duration-200">
          <div className="bg-white rounded-3xl max-w-md w-full p-6 sm:p-7 shadow-2xl border border-slate-100 flex flex-col space-y-5 relative">
            {/* Header */}
            <div className="flex items-center justify-between pb-4 border-b border-slate-100">
              <div className="flex items-center gap-3">
                <div className="w-11 h-11 rounded-2xl bg-gradient-to-tr from-emerald-600 to-teal-600 text-white flex items-center justify-center font-bold text-lg shadow-md shadow-emerald-500/20">
                  💬
                </div>
                <div>
                  <h3 className="font-extrabold text-slate-900 text-sm flex items-center gap-2">
                    <span>WhatsApp যুক্ত করুন (Web QR)</span>
                    <span className="px-2 py-0.5 rounded-full bg-emerald-100 text-emerald-800 text-[10px] font-bold">
                      Zero Meta API
                    </span>
                  </h3>
                  <p className="text-[11px] text-slate-500 mt-0.5">
                    সাধারণ WhatsApp দিয়ে স্ক্যান করে প্রজেক্টে এআই সক্রিয় করুন
                  </p>
                </div>
              </div>
              <button
            ...
            {botStatus === 'connected' ? (
                ...
                <div className="p-5 rounded-2xl bg-gradient-to-br from-emerald-50 to-teal-50 border border-emerald-200 text-center space-y-3">
                  ...
                  <div>
                    <h4 className="font-extrabold text-emerald-950 text-base">
                      WhatsApp সফলভাবে সংযুক্ত হয়েছে!
                    </h4>
                    <p className="text-xs text-emerald-800 font-mono font-bold mt-1">
                      📱 সংযুক্ত নম্বর: +{connectedPhone}
                    </p>
                    {connectedUser && (
                      <p className="text-[11px] text-emerald-600 mt-0.5">
                        প্রোফাইল: {connectedUser}
                      </p>
                    )}
                  </div>
              ...
              <div className="space-y-4 text-center">
                {/* QR Code Container */}
                <div className="relative inline-block mx-auto p-2 bg-white rounded-2xl border-2 border-emerald-400 shadow-lg">
                  <img
                    src={qrDataUrl}
                    alt="WhatsApp Web QR Code"
                    className="w-56 h-56 mx-auto rounded-xl object-contain"
                  />
                  <div className="absolute -bottom-2 left-1/2 -translate-x-1/2 px-2.5 py-0.5 rounded-full bg-emerald-600 text-white text-[10px] font-bold shadow-md">
                    স্ক্যান করার জন্য রেডি
                  </div>
                </div>
                ...
                <div className="p-3.5 bg-slate-50 rounded-2xl border border-slate-200/80 text-left space-y-1.5 text-xs">
                  <p className="font-extrabold text-slate-800 text-[11px] uppercase tracking-wider flex items-center gap-1.5">
                    ...
                    <span>আপনার ফোন থেকে যেভাবে লিংক করবেন:</span>
                  </p>
                  <ol className="list-decimal list-inside space-y-1 text-slate-600 text-[11px]">
                    <li>
                      ফোনে <strong className="text-slate-900">WhatsApp</strong> অ্যাপটি খুলুন।
                    </li>
                    <li>
                      উপরে ডানদিকের <strong className="text-slate-900">মেনু (⋮) বা Settings</strong>-এ যান।
                    </li>
                    <li>
                      <strong className="text-emerald-700">Linked Devices (যুক্ত ডিভাইস)</strong>-এ চাপুন।
                    </li>
                    <li>
                      <strong className="text-emerald-700">Link a Device (ডিভাইস যুক্ত করুন)</strong> দিয়ে এই QR কোডটি স্ক্যান করুন।
                    </li>
                  </ol>
                </div>
                ...
                <div className="flex items-center justify-between text-xs text-slate-500 px-1 pt-1">
                  <span className="flex items-center gap-1.5 text-[11px]">
                    ...
                    <span>স্ক্যান করলে স্বয়ংক্রিয় কানেক্ট হবে...</span>
                  </span>
                  <button
                  ...
                  >
                    <RefreshCw className={`w-3 h-3 ${qrRefreshLoading ? 'animate-spin' : ''}`} />
                    <span>QR রিফ্রেশ</span>
                  </button>
                </div>
              </div>
            ) : (
              <div className="py-10 flex flex-col items-center justify-center text-center space-y-3">
                ...
                <h4 className="font-extrabold text-slate-800 text-sm">
                  WhatsApp কিউআর কোড প্রস্তুত হচ্ছে...
                </h4>
